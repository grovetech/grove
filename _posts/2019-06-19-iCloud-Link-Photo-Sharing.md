...
6.  After iOS prepares the items for sharing, it puts the iCloud link on
    the clipboard.
...
<img alt="Blog Photo" src="{{ site.site_cdn }}/assets/img/blog/2019/icloudlink/image7.jpg" class="img-fluid rounded m-2" width="700" />
